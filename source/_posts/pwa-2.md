...
我们知道，在chrome（等一些现代浏览器）中，你可以将访问的网站添加到桌面，这样就会在桌面生成一个类似“快捷方式”的图标，当你点击该图标时，便可以快速访问该网站（Web App）。我们以[第一篇文章](/2018/04/07/pwa-1/)中的demo为例，其添加到桌面后以及重新打开时的状态如下：
...
好了，这篇文章的内容就到这里了。欢迎关注[《PWA学习与实践》](/2018/04/07/pwa-1/)系列。
